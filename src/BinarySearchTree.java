...
/*------------------------------------------------------------------------------------------------ */
    ...
    public boolean searchOzanNotRecursive(T val){
        TNode<T> iterator=root;
        while (true){
            if (iterator.value.compareTo(val)==0){
                return true;
            }
            else if (iterator.value.compareTo(val)==-1){ //val daha büyük
                if (iterator.right!=null){
                    iterator=iterator.right;
                }
                else return false;
    ...
    public void findParentOzan(T val){
        TNode<T> iterator=root;
